...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\USER\Documents\Project\Python\Project Batik\Web\batik'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\USER\Documents\Project\Python\Project Batik\Web\batik\Scripts\deactivate.nu'
